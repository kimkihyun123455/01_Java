...
public class CharacterService {
	...
	public void fileInput() {
		...
		try {
			...
			while(true) {
				...
				// BufferedReader.readLine() : 한줄 씩 문자열을 읽는 역할
				//개행문자가 나올때까지의 문자열을 읽는다
				line = br.readLine();
				
				if(line==null) break;//더이상 읽어올 내용이 없을 때 반복 종료
	...
	public void fileOutput() {
		...
		BufferedWriter bw = null; // 문자 보조 파일 출력 스트림
		...
		try {
			...
			//bw.flush(); close 구문이에 포함되어 있기 때문에 close가 있다면 안써도 괜찮다
